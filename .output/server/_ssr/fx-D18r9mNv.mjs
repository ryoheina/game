...
//#region node_modules/.nitro/vite/services/ssr/assets/fx-D18r9mNv.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function Particles({ count = 40, color = "arcane", className = "" }) {
...
function Fog({ opacity = .35, className = "" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		"aria-hidden": true,
		className: `pointer-events-none absolute inset-0 ${className}`,
		style: {
			background: "radial-gradient(60% 40% at 30% 80%, oklch(0.72 0.19 245 / 0.20), transparent 70%), radial-gradient(50% 30% at 80% 20%, oklch(0.82 0.14 88 / 0.12), transparent 70%)",
			mixBlendMode: "screen",
			opacity,
